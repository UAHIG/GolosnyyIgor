...
<table align="center">
  <tr>
    <td><img src="assets/icons/techstack.gif" width="20%" height="20%" alt="techstack"></td>
    <td>
      <pre><code>
      UAHIG { 
        position: Poland; 
    ...
    <td><img src="assets/icons/ScrUserPhoto.png" width="20%" height="20%" alt="ProfilePhoto"/></td>
    <td>
      <table>
        <tr>
